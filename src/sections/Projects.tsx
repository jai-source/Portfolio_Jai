...
const getProjectLabel = (category: Project['category']) => (
  category === 'systems' ? 'Backend' : category === 'ai' ? 'NLP' : 'Full stack'
);
...
export const Projects: React.FC = () => {
  ...
  const projects: Project[] = [
    {
      ...
      accent: '#3B82F6',
      mockup: (
        <div className="relative h-36 w-full overflow-hidden rounded-lg border-4 border-black bg-[#121214] p-3 font-mono text-[9px] text-stone-400 sm:h-44 sm:text-[10px]">
    ...
    },
    {
      ...
      accent: '#60A5FA',
      mockup: (
        <div className="relative flex h-36 w-full items-center justify-center overflow-hidden rounded-lg border-4 border-black bg-[#121214] sm:h-44">
    ...
    },
    {
      ...
      accent: '#3B82F6',
      mockup: (
        <div className="flex h-36 w-full flex-col justify-between overflow-hidden rounded-lg border-4 border-black bg-[#121214] p-3 font-mono text-[8px] sm:h-44 sm:text-[9px]">
    ...
    },
    {
      ...
      accent: '#60A5FA',
      mockup: (
        <div className="flex h-36 w-full flex-col justify-between overflow-hidden rounded-lg border-4 border-black bg-[#121214] p-3 sm:h-44">
  ...
  return (
    <section id="projects" className="relative border-t-4 border-black bg-[#1C1C1F] px-4 py-14 sm:px-6 sm:py-20 md:px-8 md:py-24 xl:px-16">
      <div className="pointer-events-none absolute inset-0 bg-dot-pattern opacity-30" />

      <div className="relative z-10 mx-auto w-full max-w-7xl">
        <div className="mb-8 flex flex-col justify-between gap-4 text-left sm:mb-12 sm:gap-6 md:mb-16 md:flex-row md:items-end">
          <div>
          ...
          <div className="grid w-full grid-cols-2 gap-2.5 sm:flex sm:w-auto sm:flex-wrap">
            {(['all', 'systems', 'fullstack', 'ai'] as const).map((filter) => (
              <button
                ...
                className={`
                  flex cursor-pointer justify-center rounded-md border-2 border-black px-3 py-2 font-grotesk text-[11px] font-bold uppercase tracking-wider transition-all duration-150 select-none sm:px-4 sm:text-xs
        ...
        <motion.div layout className="grid grid-cols-1 gap-4 sm:gap-6 md:grid-cols-2 md:gap-10">
                ...
                >
                  <div className="hidden h-full md:flex md:flex-col md:justify-between">
                    <div>
                      ...
                      <div className="mb-2.5 flex flex-col gap-1.5 sm:mb-3 sm:flex-row sm:items-center sm:justify-between">
                        <h3 className="text-xl font-black tracking-tight sm:text-2xl">{project.title}</h3>
                      ...
                      <p className="mb-4 text-[13.5px] font-semibold leading-6 text-stone-700 sm:mb-6 sm:text-[15px] sm:leading-relaxed">
                        {project.description}
                      </p>
                    </div>

                    <div>
                      <div className="mb-4 flex flex-wrap gap-1 sm:mb-6 sm:gap-1.5">
                        {project.tags.map((tag) => (
                          <span
                            key={tag}
                            className="rounded-sm border border-black bg-[#EAEAEA] px-2 py-0.5 font-mono text-[9px] font-bold text-black sm:text-[10px]"
                          >
                            {tag}
                          </span>
                        ))}
                      ...
                      <div className="mt-auto flex flex-col gap-3 border-t-2 border-black pt-3 sm:flex-row sm:items-center sm:justify-between sm:pt-4">
                        <div className="flex items-center gap-1.5 text-[11px] font-black uppercase text-stone-500 sm:text-xs">
                          <FaCode className="text-base" /> {getProjectLabel(project.category)}
                        </div>
                        <div className="flex w-full flex-wrap gap-3 sm:w-auto">
                          {project.github && (
                            <a
                              ...
                              target="_blank"
                              rel="noreferrer"
                              className="flex flex-1 items-center justify-center gap-1.5 rounded border-2 border-black bg-[#27272A] px-3 py-1.5 text-[11px] font-extrabold uppercase tracking-tight text-white transition-colors duration-150 hover:bg-portfolio-primary hover:text-white sm:flex-none sm:text-xs brutal-shadow"
                          ...
                          {project.live && (
                            <a
                              ...
                              target="_blank"
                              rel="noreferrer"
                              className="flex flex-1 items-center justify-center gap-1.5 rounded border-2 border-black bg-white px-3 py-1.5 text-[11px] font-extrabold uppercase tracking-tight text-black transition-colors duration-150 hover:bg-portfolio-primary hover:text-white sm:flex-none sm:text-xs brutal-shadow"
                              style={{ boxShadow: '2px 2px 0px 0px #000000' }}
                            >
                  ...
                  <div className="md:hidden">
                    ...
                    <MobileDisclosure contentClassName="mt-4">
                      <div className="space-y-4">
                        <div>{project.mockup}</div>

                        <p className="text-[13.5px] font-semibold leading-6 text-stone-700">
                          {project.description}
                        </p>
                        ...
                        <div className="flex flex-wrap gap-1">
                          {project.tags.map((tag) => (
                            <span
                              key={tag}
                              className="rounded-sm border border-black bg-[#EAEAEA] px-2 py-0.5 font-mono text-[9px] font-bold text-black"
                            >
                              {tag}
                            </span>
                          ))}
                        ...
                        <div className="flex flex-col gap-3 border-t-2 border-black pt-3">
                          <div className="flex items-center gap-1.5 text-[11px] font-black uppercase text-stone-500">
                            <FaCode className="text-base" /> {getProjectLabel(project.category)}
                          </div>
                          <div className="flex w-full flex-wrap gap-3">
                            {project.github && (
                              <a
                                ...
                                target="_blank"
                                rel="noreferrer"
                                className="flex flex-1 items-center justify-center gap-1.5 rounded border-2 border-black bg-[#27272A] px-3 py-1.5 text-[11px] font-extrabold uppercase tracking-tight text-white transition-colors duration-150 hover:bg-portfolio-primary hover:text-white brutal-shadow"
                                style={{ boxShadow: '2px 2px 0px 0px #000000' }}
                              >
                                <FaGithub className="text-sm" /> Code
                              </a>
                            ...
                            {project.live && (
                              <a
                                ...
                                target="_blank"
                                rel="noreferrer"
                                className="flex flex-1 items-center justify-center gap-1.5 rounded border-2 border-black bg-white px-3 py-1.5 text-[11px] font-extrabold uppercase tracking-tight text-black transition-colors duration-150 hover:bg-portfolio-primary hover:text-white brutal-shadow"
                                style={{ boxShadow: '2px 2px 0px 0px #000000' }}
                              >
                                <FaExternalLinkAlt className="text-xs" /> Launch
                              </a>
